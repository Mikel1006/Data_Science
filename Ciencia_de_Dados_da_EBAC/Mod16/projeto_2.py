...
st.set_page_config(
     page_title="Analise Previsão de Renda - Mikel Tanner",
     page_icon="🧑‍🎓",
     layout="wide",
)

st.write('# Análise exploratória da previsão de renda') 
st.write('### EBAC - Mod 16 - 🧑‍🎓 Mikel Tanner')

renda = pd.read_csv('https://raw.githubusercontent.com/Mikel1006/Data_Science/refs/heads/main/Ciencia_de_Dados_da_EBAC/Mod16/previsao_de_renda.csv')
